  ...
  return (
    <div className=" flex items-center justify-center h-full ">
      <div className=" text-center max-w-[40rem] mx-auto ">
        <h2 className=" text-[2rem] md:text-[2.5rem] font-semibold ">
          Check Appointment Availability
        </h2>
        <p className=" text-base md:text-xl ">
          Easily find available slots and book your appointment with ease. Get
          real-time updates and seamless scheduling assistance.
        </p>
      </div>
    </div>
  );
