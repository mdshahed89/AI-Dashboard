...
const DefaultSection = () => {
  return (
    <div className=" flex items-center justify-center h-full ">
      ...
      <h2 className=" text-[2rem] md:text-[2.5rem] font-semibold ">Schedule Your Appointment</h2>
      <p className=" text-base md:text-xl ">
      Book your appointment hassle-free. Choose a convenient time and get instant confirmation in just a few clicks.
      </p>
      </div>
    </div>
  );
