...
const DefaultSection = () => {
  return (
    <div className=" flex items-center justify-center h-full ">
      ...
      <h2 className=" text-[2rem] md:text-[2.5rem] font-semibold ">Welcome to ai chat bot</h2>
      <p className=" text-base md:text-xl ">
        Experience seamless and intelligent conversations with AI-powered chat.
        Get instant responses, insights, and assistance anytime.
      </p>
      </div>
    </div>
  );
