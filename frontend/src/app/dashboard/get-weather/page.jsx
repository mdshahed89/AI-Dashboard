...
const DefaultSection = () => {
  return (
    <div className=" flex items-center justify-center h-full ">
      ...
      <h2 className="text-[2rem] md:text-[2.5rem] font-semibold ">Check the Latest Weather</h2>
      <p className=" text-base md:text-xl ">
      Stay updated with real-time weather conditions. Get accurate forecasts and plan your day with confidence.
      </p>
      </div>
    </div>
  );
